...
static bool is_word_char(char c) { return ((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISalnum) || c == '_'; }
bool lex_identifier(const char* s, token* tok) {
...
bool is_keyword(const char* s, size_t len) {
  if (keywords_map.size == 0) {
    ...
    hashmap_entry entry = {.data = ((void *)0), .data_size = 0};
...
static const char* consume_int_suffix(const char* s) {
  char c = tolower(*s);
  if (c != 'u' && c != 'l') {
    return is_word_char(*s) ? ((void *)0) : s;
  }
...
static const char* consume_exponent(const char* s) {
  ...
  while (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISdigit)) {
    ++s;
  }
  return s;
}
...
static const char* consume_hex(const char* s, token* tok) {
  const char* start = s;
  s += 2;
  if (!((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISxdigit) && *s != '.') {
    return ((void *)0);
  }
  if (s[0] == '.' && !((*__ctype_b_loc ())[(int) ((s[1]))] & (unsigned short int) _ISxdigit)) {
    return ((void *)0);
  }
  while (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISxdigit)) {
    ++s;
  }
  if (*s != '.' && !is_hex_exp_char(*s)) {
    do { s = consume_int_suffix(s); if (!s) { return ((void *)0); } } while (0);
    tok->token_type = TK_ICONST;
    tok->constant.int_val = strtoull(start, ((void *)0), 16);
    return s;
  }
  if (*s == '.') {
    ++s;
  ...
  ++s;
  do { s = consume_exponent(s); if (!s) { return ((void *)0); } } while (0);
  do { s = consume_float_suffix(s); if (!s) { return ((void *)0); } } while (0);
  tok->token_type = TK_FCONST;
  tok->constant.float_val = strtold(start, ((void *)0));
  return s;
}
...
static const char* consume_dec_or_oct(const char* s, token* tok) {
  if (!((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISdigit) && *s != '.') {
    return ((void *)0);
  }
  if (s[0] == '.' && !((*__ctype_b_loc ())[(int) ((s[1]))] & (unsigned short int) _ISdigit)) {
    return ((void *)0);
  }
  const char* start = s;
  ...
  if (*s != '.' && !is_dec_exp_char(*s)) {
    ...
    do { s = consume_int_suffix(s); if (!s) { return ((void *)0); } } while (0);
    tok->token_type = TK_ICONST;
    tok->constant.int_val = strtoull(start, ((void *)0), is_oct ? 8 : 10);
    return s;
  }
  if (*s == '.') {
    ++s;
...
bool lex_punctuator(const char* s, token* tok) {
  if (!((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISpunct)) {
    return false;
  }
...
static const char* consume_hex_escape_sequence(const char* s, uint32_t* dst,
  ...
  while (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _ISxdigit)) {
    ...
    if (((*__ctype_b_loc ())[(int) ((digit))] & (unsigned short int) _ISdigit)) {
      c |= digit - '0';
    } else {
      c |= (digit - 'a' + 10);
    }
...
static const char* consume_wide_char_body(const char* s, uint32_t* dst) {
  ...
  if (*s == '\\') {
    ++s;
    do { s = consume_escape_sequence(s, dst, char_width); if (!s) { return ((void *)0); } } while (0);
  } else {
    s = decode_utf8(s, dst);
  }
  if (*s != '\'') {
...
static const char* consume_char_body(const char* s, uint32_t* dst) {
  ...
  while (*s != '\0' && *s != '\n') {
    ...
    if (*s == '\\') {
      ++s;
      uint32_t escape = 0;
      do { s = consume_escape_sequence(s, &escape, CW_UTF8); if (!s) { return ((void *)0); } } while (0);
      c = (uint8_t)escape;
    } else {
      c = *s;
      ++s;
...
static const char* consume_utf16_str_body(const char* s, array* arr) {
  ...
  while (*s != '\0' && *s != '\n') {
    ...
    if (*s == '\\') {
      ++s;
      uint32_t c = 0;
      do { s = consume_escape_sequence(s, &c, CW_UTF16); if (!s) { return ((void *)0); } } while (0);
      void* dst = array_push_back(arr);
...
static const char* consume_utf32_str_body(const char* s, array* arr) {
  ...
  while (*s != '\0' && *s != '\n') {
    ...
    if (*s == '\\') {
      ++s;
      uint32_t c = 0;
      do { s = consume_escape_sequence(s, &c, CW_UTF32); if (!s) { return ((void *)0); } } while (0);
      void* dst = array_push_back(arr);
      *(uint32_t*)dst = c;
    } else {
      uint32_t c = 0;
